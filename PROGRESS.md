...
- 최신 배포: 2026-06-28 커밋 `99c7039` — 즐겨찾기 타지역 마커 · 추세 3년 · 추세 평형별만 ·
  뉴스 전체탭 · 평형 네이버부동산 매물 딥링크 · 세부패널 네이버 탭화.
...
- ✅ 네이버 부동산 **매물 딥링크 괄호 버그 수정(2026-06-30, 미배포)**: 국토부 단지명 괄호("동편마을(3단지)")가
